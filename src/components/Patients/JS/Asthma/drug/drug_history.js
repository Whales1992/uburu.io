...
const DrugHistory = () => {
  ...
  const drugs = ["Salbutamol", "Albuterol", "Salmeterol", "Formoterol", "Budesonide", "Fluticasone", "Prednisolone", "Methylprednisolone", "Montelukast", "Zafirlukast", "Seretide", "Flutiform"]
