      ...
      <Shell name={`${bioData.LastName} ${bioData.FirstName}`}>
        <form className={styles.form} onSubmit={(e) => update(e)}>
          <div className={styles.fields}>
            ...
            <div>
              <label htmlFor="OrganDiagnosis">Organ Diagnosis</label>
              <select
                id="OrganDiagnosis"
                name="OrganDiagnosis"
                value={value.OrganDiagnosis}
                onChange={(e) => handleChange('OrganDiagnosis', e)}
                className={styles.input}
                required
              >
                <option></option>
            ...
            <div>
              <label htmlFor="HistoDiagnosis">Hispathology Diagnosis</label>
              <input
                id="HistoDiagnosis"
                name="HistoDiagnosis"
                type="text"
                onChange={(e) => handleChange('HistoDiagnosis', e)}
