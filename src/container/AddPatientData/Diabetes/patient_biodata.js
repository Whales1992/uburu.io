	...
	constructor(props) {
		...
		this.state = {
			biodata: {
				...
				diabetes_diagnosis:
					JSON.parse(localStorage.bio_data).diabetes_diagnosis || "",
				...
				self_glucose_monitoring:
					JSON.parse(localStorage.bio_data).self_glucose_monitoring ||
					""
			},
			//end of parameters
			submitting: false
					...
					patient: {
						...
						AlcoholUse:
							alcohol_use === "Yes"
								? alcohol_frequency
								: alcohol_use,
						DiabetesHistory: family_history_of_diabetes,
						SelfGlucoseMonitoring: self_glucose_monitoring
					}
				})
			});
				...
				<Shell>
					<form className={styles.form}>
						...
						<div className={styles.fields}>
							...
							<div>
								<label htmlFor="diabetes_diagnosis">
									Diabetes Diagnosis
								</label>
								<select
									id="diabetes_diagnosis"
									name="diabetes_diagnosis"
									value={diabetes_diagnosis}
									onChange={(e) => this.handleChange(e)}
									className={styles.input}
									required
								>
							...
							<div>
								<label htmlFor="family_history_of_diabetes">
									Family History of Diabetes
								</label>
								<select
									id="family_history_of_diabetes"
							...
							<div>
								<label htmlFor="self_glucose_monitoring">
									Self Glucose Monitoring
								</label>
								<select
									id="self_glucose_monitoring"
									name="self_glucose_monitoring"
									value={self_glucose_monitoring}
									onChange={(e) => this.handleChange(e)}
									className={styles.input}
								>
									<option></option>
