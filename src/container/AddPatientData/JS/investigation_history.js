			...
			<>
				...
				<form className={styles.form}>
					...
					<DatePicker
						...
						onChange={(e) => this.handleDateChange("last_ray", e)}
						value={last_xray}
						format="dd MMMM y"
						clearIcon={null}
						required
					...
					<DatePicker
						...
						className={styles.input}
						onChange={(e) =>
							this.handleDateChange("last_ultrasound", e)
						}
					...
					<DatePicker
						name="CA125_date"
						className={styles.input}
						onChange={(e) => this.handleDateChange("CA125_date", e)}
						value={CA125_date}
						format="dd MMMM y"
						clearIcon={null}
						required
					...
					<DatePicker
						name="PSA_date"
						className={styles.input}
						onChange={(e) => this.handleDateChange("PSA_date", e)}
						value={PSA_date}
						format="dd MMMM y"
						clearIcon={null}
						required
